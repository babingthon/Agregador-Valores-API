...
public class UserController {
    ...
    public ResponseEntity<Void> creatAccount(@PathVariable("userId") Long userId,
    ...
    public ResponseEntity<List<AccountResponseDto>> listAccounts(@PathVariable("userId") Long userId){
